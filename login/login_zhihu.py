...
def login(username, password, oncaptcha):
    ...
    _xsrf = BeautifulSoup(sessiona.get('https://www.zhihu.com/#signin', headers=headers).content, 'html.parser').find(
    ...
    print sessiona.cookies
    print(resp)
    return resp


if __name__ == "__main__":
    login('email@email.cn', 'xxxxx', get_captcha)
